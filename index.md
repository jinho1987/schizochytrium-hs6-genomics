...
<section class="block">
  ...
  <ul class="nav-list">
    ...
    <li><a href="colony-screening.html"><span>Environmental Colony Screening: Schizochytrium-likeness Ranking <span class="d">60 environmental sample plates screened against 5 lab reference strains via a from-scratch image pipeline (dish detection, local-contrast colony segmentation, isolation filtering) — plus an honest look at whether the reference strains can be told apart (they cannot, yet, with current data)</span></span></a></li>
